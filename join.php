...
<i class="fa fa-edit"></i>
              ...
              <li class="nav-item">
                <a class="nav-link active" href="join.php">
                          ...
                          <form action="joindata.php" method="post">
                            ...
                            <div class="form-row">
                              <div class="form-group col-md-12">
                                <label for="feEmailAddress">Class Code</label>
                                <input type="text" class="form-control" id="feEmailAddress" placeholder="Enter Class code" name="code"> </div>
                                  </div>
