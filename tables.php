          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle">Connection</span>
...
$sql1 = "
select * from classcreate where classcode='$c1'";
...
$sql2 = "
select join1.name,join1.email,profile.about from join1 inner join profile on profile.email=join1.email and classcode='$c3'";
...
?>
                   <tbody>
                        <tr>
                          ...
                          <td><a href="mail1.php?jnjksnfjskdnflsdfnnlksdnldsvdsk=<?=$c5?>"><?=$c5?></a></td>
                        </tr>
...
?> 
          ...
          </div> <footer class="main-footer d-flex p-2 px-3 bg-white border-top">
            <ul class="nav">
              <li class="nav-item">
