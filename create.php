                          ...
                          <form action="createdata.php" method="post">
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="feFirstName">Class Name</label>
                                <input type="text" class="form-control" id="feFirstName" name="cname" placeholder="class name" > </div>
                              <div class="form-group col-md-6">
                                <label for="feLastName">Section</label>
                                <input type="text" class="form-control" id="feLastName" placeholder="A,b,c.." name="section"> </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-12">
                                <label for="feEmailAddress">Subject</label>
                                <input type="text" class="form-control" id="feEmailAddress" placeholder="Subject name.." name="subject"> </div>
                                  </div>
                          
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="feEmailAddress">Marks(optional)</label>
                                <input type="text" class="form-control" id="feEmailAddress" placeholder="40 marks" name="marks"> </div>
                              <div class="form-group col-md-6">
                                <label for="fePassword">Submission-Time(optional)</label>
                                <input type="date" class="form-control" id="fePassword" placeholder="2 jun 2020" name="submittime"> </div>
                            </div>
